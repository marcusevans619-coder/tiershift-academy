            ...
            >
              ...
              <div style='' flex: 1, minWidth: 0 }}>
                ...
                <div style='' display: "flex", gap: 16, fontSize: 13, color: T.muted }}>
                  <span>'String.fromCodePoint(0x1F4CA)} Passing: 'cert.passing_score}%</span>
                  'cert.validity_months && (
                    <span>'String.fromCodePoint(0x23F1)} Valid: 'cert.validity_months} months</span>
                  )}
                </div>
              </div>
              </div>
                ...
                >
                  ...
                  'q.explanation && (
                    <div style=''
                      ...
                      'String.fromCodePoint(0x1F4A1)} 'q.explanation}
                    </div>
                  )}
                </div>
              );
      ...
      <div style=''
        ...
        <div>
          ...
          <div style='' color: T.muted, fontSize: 13, marginTop: 4 }}>
            Question 'currentQ + 1} of 'questions.length} 'String.fromCodePoint(0x2022)} 'answeredCount} answered
          </div>
        </div>
        ...
        <div style='' display: "flex", alignItems: "center", gap: 20 }}>
          <div style=''
            ...
            'String.fromCodePoint(0x23F1)} 'formatTime(timeLeft)}
          </div>
          <button
            onClick='onCancel}
            style=''
    ...
    <div style=''
      ...
      <div style='' display: "flex", gap: 20, alignItems: "center", position: "relative", flexWrap: "wrap" }}>
        ...
        <div style='' flex: 1, minWidth: 0 }}><div style='' display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
          ...
          <div style='' display: "flex", gap: 16, fontSize: 13, color: T.muted }}>
            <span>'String.fromCodePoint(0x1F4C5)} Earned: 'new Date(userCert.earned_at).toLocaleDateString()}</span>
            'userCert.score && <span>'String.fromCodePoint(0x1F4CA)} Score: 'userCert.score}%</span>}
            'userCert.expires_at && (
              <span style='' color: isExpired ? T.danger : T.muted }}>
                'String.fromCodePoint(0x23F1)} 'isExpired ? "Expired" : "Valid until"}: 'new Date(userCert.expires_at).toLocaleDateString()}
              </span>
            )}
          </div>
        </div>
...
<body>
  <div class="certificate">
    ...
    <div class="icon">'String.fromCodePoint(0x1F3C6)}</div>
