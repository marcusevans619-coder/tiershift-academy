...
export default function LessonGenerator({ module, onClose, onSaved }) {
  ...
  async function generateOutline() {
    ...
    try {
      ...
      setTitle(module.name + ' �?�?�?¢�?¢â'\u20AC'š�?¬�?¢â�??¬�? ' + selected.snippet.title.slice(0, 50));
      setStep('preview');
      setStatus('');
    } catch (err) {
  ...
  return (
    <div style={S.overlay}>
      <div style={S.modal}>
        <button style={S.closeBtn} onClick={onClose}>�?�?�?'�?¢â�??¬â'\u20AC'</button>
        <div style={S.title}>Generate Lesson �?�?�?¢�?¢â'\u20AC'š�?¬�?¢â�??¬�? {module.name}</div>
          ...
          <div>
            <div style={S.section}>
              ...
              <div style={{
                ...
                {usedTranscript ? '�?�?�?¢�?�?�â'\u20AC'�?�?¢â�??¬�?" Generated from video transcript' : '�?�?�?¢�?�?��?¡�?�??�?  Generated from video title (no transcript available)'}
              </div>
            </div>
            <div style={S.section}>
